...
public class productController {
    ...
    @FXML private void Search(){
        ...
        Long count = DBManager.queryForSingleResult(Long.class,"select count(c) from SaleProduct C where c.name=?1",search);
        ...
        if (search.isEmpty() || count<1){
            ...
            SaleProduct product = DBManager.queryForSingleResult(SaleProduct.class, "select c from SaleProduct c where c.name=?1", search);
